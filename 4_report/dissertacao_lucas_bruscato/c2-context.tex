...
As variáveis utilizadas como explicativas para modelagem do problema proposto foram extraídas do censo demográfico do IBGE dos anos 2000 e 2010. Foram feitas três abordagens distintas sobre as variáveis explicativas, essas são:
...
O código para criação das variáveis citadas no parágrafo anterior foi escrito na linguagem de programação Python utilizando a ferramenta Notebook Jupyter e se encontra no anexo (ref. - 02_data_processing).
...
Utilizando como chave estrangeira a informação de munício e estado, realizou-se a união das informações citadas nas seções (ref. - variável resposta) e (ref. - variáveis explicativas) e, assim, foram obtidas as bases para modelagem do problema proposto neste trabalho. Assim, por meio do método de amostragem aleatória, selecionou-se setenta e cinco por cento da base gerada para desenvolvimento do modelo e vinte e cinco por cento para validação (ref. - cross validation).

O código desenvolvido para criação da base citada no parágrafo anterior foi escrito na linguagem de programação Python utilizando a ferramenta Notebook Jupyter e se encontra no anexo (ref. - 02_data_processing).



<<< ARRUMAR CÖDIGO 02_data_processing >>>
