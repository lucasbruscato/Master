...
O modelo Random Forest não possui uma fácil interpretabilidade, apesar de ser possível ver e analisar a estrutura de cada uma das árvores que compõe o mesmo, não é direta a interpretação de como foi feita a predição dos valores por tal algoritmo. Assim, uma forma 
